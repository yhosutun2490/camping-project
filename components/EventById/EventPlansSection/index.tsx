...
export default function EventPlansSection({data=mockPlans}: Props) {
    ...
    <FormProvider {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 p-6">
        ...
        >
          ...
          <EventPlanSelector name="plan" plans={mockPlans}/>
          <EventAddonCheckbox name="addon" options={addonOptions} />
        </div>
      </form>
    </FormProvider>
  );

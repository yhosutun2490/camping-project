  ...
  return (
    <div
      className={clsx(
        ...
        "flex flex-wrap justify-between px-[1rem] md:px-[5%] lg:px-[8%] z-20 cursor-pointer delay-50 ease-in-out transition-all",
        {
      ...
      { (
        <div
          className={clsx(
            ...
            "left-[5%] sm:left-[20%] md:right-[10%] md:top-[17px] md:left-0 overflow-visible ease-in-out",
            isBarScaleUp

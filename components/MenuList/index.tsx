    ...
    <ul className={clsx("bg-white rounded-lg shadow-md", className)}>
      {list.map((item, index) => (
        <Link
          ...
          key={item.id}
          className={clsx(
            "w-full inline-block max-sm:text-sm md:text-xl text-black px-4 py-2 cursor-pointer hover:bg-gray-200",
      ...
      <li
        className="max-sm:text-sm md:text-xl text-black px-4 py-2  

...
const mockActivities:EventInfo[] = [
 {
        ...
        "host": {
            ...
            "name": "『六角瘋露營』",
            "description": "我們是全台最熱愛寫程式、同時最擅長策劃露營活動的團隊，結合科技教育與戶外探索，致力於打造寓教於樂的露營體驗。不論是新手家庭、熱血學生、還是科技業夥伴，我們都能設計出兼具實用技能學習與自然生活體驗的活動內容。透過精緻的課程設計、專業的活動引導與完善的後勤支援，讓每一位參與者都能在山林間獲得成長、交流與放鬆。",
        ...
        "photos": [
            ...
            },
            {
                ...
                "description": "在野地的山林，築起營火，溫暖身在自然中的我們彼此，拾起童心與共享天倫之樂！",
            ...
            },
            {
                ...
                "description": "被大自然環抱著，回歸最樸實的初心，搭營倚著河畔，和最愛的家人重拾最初最天然的自己，把煩惱拋出山林之外！",
        ...
        "notices": [
            ...
            },
            {
                ...
                "event_info_id": "d30a54cf-b1bb-4b2b-bafe-607dcae4a985",
                "type": "行前提醒",
                "content": "集合地點：活動開始當天在樂灣糧倉園區(如地址所示)集合，請準時集合以便順利出發。",
                "created_at": "2025-06-12T07:45:45.677Z",
                "updated_at": "2025-06-12T07:45:45.677Z"
            },
            {
        ...
        "plans": [
            {
                ...
                "eventPlanContentBox": [
                    ...
                    },
                    {
                        ...
                        "event_plan_id": "9a0acefc-f274-43a3-acf7-8b35491e4cfe",
                        "content": "專人搭設 SKYDOME 雙層透氣帳，帳內附設地墊、LED 燈條、野營桌椅",
                        "created_at": "2025-05-06T06:02:24.511Z",
                        "updated_at": "2025-05-06T06:02:24.511Z"
                    },
                    {
        ...
        "tags": [
            {
                ...
                "name": "進階挑戰",
                "description": "這不是 Glamping，這是硬派挑戰！野地搭帳、生火烹飪、無電原始生活，邀請你和自然正面對決。你會發現，簡單生活才是最極致的浪漫，每一次挑戰都讓你更靠近真正的野營玩家。",
                "level": "hard"
            },
            {
                "id": "22c5ca29-8700-4ac6-aeac-7631440d8aca",
                "name": "團體活動",
                "description": "不只是露營，更是一場團隊挑戰賽！闖關任務、默契大考驗，適合公司團建、學校社團或好朋友，一起笑、一起瘋，留下最真實的回憶與凝聚力爆棚的夥伴情。",
                "level": "medium"
            },
            {
                "id": "05ea9e21-1964-4dd3-976a-82939be58d4f",
                "name": "騎士 Chill 行",
                "description": "引擎一發，旅程就開始了。重機騎士專屬的露營基地，白天馳騁山路、晚上營火談車、帳篷旁停著你的寶貝機車。速度與風景共舞，這是屬於自由靈魂的帥氣夜晚。",
                "level": "medium"
            }
        ],
        "comments": [],
    ...
    <section className="mx-auto">
      ...
      <div className="mb-4 flex gap-2 overflow-x-auto">
        {["待審核", "已退回"].map((label) => (
          <button
            key={label}
            className="shrink-0 rounded-full border px-4 py-1 text-sm text-neutral-600 hover:bg-primary-50"
          >
            {label}
          </button>
        ))}
